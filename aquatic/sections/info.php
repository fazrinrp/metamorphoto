<section class="info">
    ...
    <div class="info-container">
        ...
        <div class="mempelai row justify-content-center">
            ...
            <div class="pop-up-img instagram">
                <a class="tombol" href="<?php echo $mempelai_pria_instagram ?>" target="_blank"><img class="icon"
                        src="img/instagram-icon.png" alt="">@<?php echo $mempelai_pria_instagram_username ?>
                </a>
            </div>
        </div>
    </div>
    <img class="info-bottom zoom-inout-y" src="img/main-prop/prop-8.png" alt="">
