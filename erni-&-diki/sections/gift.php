<section class="gift">
    <img src="img/prop/7.png" class="zoom-rotate-image gift-top-left" alt="Top Left Image" />
    <div>
    ...
    <div id="hiddenContent" class="hidden">
        <img src="img/prop/5.png" class="zoom-rotate-image gift-bottom-right" alt="Bottom Right Image" />
        ...
        <div class="pop-up-img giftcard justify-content-center">
            <img class="bank" src="img/logo-bank/bank-bri.png" alt="" />
            <h5>
