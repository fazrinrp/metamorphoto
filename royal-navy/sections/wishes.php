<section class="wishes">
    <div class="best-wishes">
        <h2 class="pop-up-img">Ucapan & Doa</h2>
        ...
        <div class="wish-card">
            <form id="wishForm">
                ...
                <button type="submit" class="pop-up-img btn btn-primary tombol send-message"><img class="icon"
                        src="img/send-white-icon.png" alt="">Kirim</button>
            </form>
